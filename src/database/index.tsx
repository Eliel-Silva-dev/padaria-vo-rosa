    ...
    items: [
      ...
      },
      {
        ...
        Ingredients: [
          ...
          '1 misto frio',
          '1 lanche natural',
          '(pão australiano, queijo branco , peito de peru e salada)',
          '1 suco de laranja natural 300ml',
          '1 amendoim japonês',
          '1 salgadinho torcida',
          '1 salgado assado',
...
const products = [
  ...
  },
  {
    id: 8,
    title: 'Bolo Coco Gelado',
    Ingredients: ['legitima receitinha de Vó. bolo de coco gelado molhadinho'],
    imgCard: 'img/bolocococard.png',
    imgAbout: 'img/bolococoabout.jpg',
    price: 6,
  },
  {
    ...
    title: 'Bolo no pote Ninho Trufado 250g',
    Ingredients: [
      'Bolo no pote Ninho trufado',
      'massa de Ninho com massa de chocolate',
      'com recheio de creme de Ninho trufado com chocolate.',
    ],
    imgCard: 'img/bolopoteninhotrufadocard.jpg',
    imgAbout: 'img/bolopoteninhotrufadoabout.jpg',
    price: 10,
  },
  {
    ...
    Ingredients: [
      ...
      ' massa de Ninho molhadinho',
      ' com um delicioso recheio de creme de Ninho.',
    ],
    imgCard: 'img/bolopoteninhocard.jpg',
    imgAbout: 'img/bolopoteninhoabout.jpg',
    price: 10,
  ...
  },
  {
    ...
    Ingredients: [
      'Bolo de Chocolate',
      ' com o furo do bolo cheio de chocolate',
      'cheio de Nutella',
      ' e cobertura de Nutella',
      ' com morangos.',
      'Serve 16 fatias.',
    ],
    imgCard: 'img/bolovulcaocard.jpg',
  ...
  },
  {
    id: 18,
    title: 'Pão com mortadela',
    Ingredients: ['pão Francês', ' 50g mortadela defumada'],
    imgCard: 'img/paocommortadelacard.jpg',
    imgAbout: 'img/paocommortadelaabout.jpg',
    price: 8,
  },
...
export { about, options, promoValentinesDay, products };
